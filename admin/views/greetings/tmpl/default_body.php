...
<?php foreach ($this->items as $i => $item): ?>
	<?php
		...
		$canDo = Hello_worldHelper::getActions('greeting',$item,'greetings');
	?>
	<tr class="row<?php echo $i % 2; ?>">
		...
		<?php if ($canDo->get('core.edit.state')) : ?>
				<?php if ($item->checked_out) : ?>
					<?php if ($canCheckin) : ?>
						<?php echo JHtml::_('jgrid.published', $item->published, $i, 'greetings.', true, 'cb'); ?>
					<?php else: ?>
						<?php echo JHtml::_('jgrid.published', $item->published, $i, 'greetings.', false, 'cb'); ?>
					<?php endif; ?>
				<?php else: ?>
					<?php echo JHtml::_('jgrid.published', $item->published, $i, 'greetings.', true, 'cb'); ?>
				<?php endif; ?>
